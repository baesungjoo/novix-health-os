export type Member = { id:number; name:string; phone:string; birthday:string; visits:number; interest:string; memo:string };
export type Reservation = { id:number; date:string; time:string; name:string; phone:string; status:'대기'|'확정'|'완료'|'취소'; memo:string };
...
{id:3,name:'이정자',phone:'010-7788-9900',birthday:'1955-09-14',visits:27,interest:'혈액순환',memo:'화·목 방문'},
...
{id:3,date:'2026-07-23',time:'14:00',name:'이정자',phone:'010-7788-9900',status:'완료',memo:'재방문'}];
